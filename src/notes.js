...
const itemsData = document.querySelector(".items");
...
function addItem() {
    const data = document.querySelector(".item").value;
    console.log(data);
...
function displayItems() {
    let items = itemsArray.map((item) => {
        return `<p>${item}</p><button class="edit-btn">
        <span class="material-icons"> edit </span>
      </button>`;
    }).join("");

    itemsData.innerHTML = items;
}
displayItems();*/